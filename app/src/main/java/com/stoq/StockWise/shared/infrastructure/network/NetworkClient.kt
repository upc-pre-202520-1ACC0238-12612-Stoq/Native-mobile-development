...
object NetworkClient {
    ...
    fun createDashboardApiService(jwtRepository: JwtRepository): DashboardApiService {
        return createRetrofit(jwtRepository).create(DashboardApiService::class.java)
    }

    fun createComboApiService(jwtRepository: JwtRepository): ComboApiService {
        return createRetrofit(jwtRepository).create(ComboApiService::class.java)
    }

    fun createSalesApiService(jwtRepository: JwtRepository): SalesApiService {
        return createRetrofit(jwtRepository).create(SalesApiService::class.java)
    }
